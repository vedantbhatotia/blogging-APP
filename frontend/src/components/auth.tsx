        ...
        <div className="h-screen flex justify-center flex-col">
            <div className="flex justify-center">
                <div>
                    ...
                    <div className="pt-8">
                        <LabelledInput label="Name" placeholder="Vedant Bhatotia..." onChange={handleNameChange} />
                        <LabelledInput label="Username" placeholder="vedant@gmail.com" onChange={handleUsernameChange} />
