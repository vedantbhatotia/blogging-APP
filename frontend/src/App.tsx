        ...
        <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
          <div className="space-y-4">
            ...
            <div className="flex space-x-7 animate__animated animate__fadeInUp animate__delay-2s">
              <a href="#" className="btn btn-lg bg-white text-black-500 hover:bg-gray-500 hover:text-white transition duration-300 ease-in-out transform hover:-translate-y-1">
                Sign Up
              </a>
              <a href="#" className="btn btn-lg bg-white text-black-500 hover:bg-gray-500 hover:text-white transition duration-300 ease-in-out transform hover:-translate-y-1">
                Sign In
